...
/**
 * Reads properties from an instance via reflection and stores the results as
 * a TraceRecord
 * 
 * @author Greg Higgins (greg.higgins@V12technology.com)
 */
public class PropertyReader implements TraceRecord {
    ...
    public void recordValue() {
        if (field != null) {
            value.setLength(0);
            try {
                value.append(FieldUtils.readField(field, instance, true).toString());
